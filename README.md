...
2. To visualize confirmed, recovered, and deceased cases interactively.

3. To create a time-series model showing daily/weekly/monthly patterns.

4. To build a clean and user-friendly Power BI dashboard.
...
1. raw_data_Indian_states.csv

2. vaccination_data.csv
...
Map Visual: Shows state-wise distribution of COVID-19 cases.

Clustered Column Chart: Comparison of cases across states.
...
Recovery rate increases over time due to improved healthcare response.

Some states exhibit consistent high caseloads due to higher population density.
